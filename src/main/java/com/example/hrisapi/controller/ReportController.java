...
public class ReportController {
    ...
    public ResponseEntity<JsonBaseResponse<PaginatedResponse<ReportTagihanGajiResponse>>> reportTagihanGaji(
    ...
    {
        var body = new JsonBaseResponse<PaginatedResponse<ReportTagihanGajiResponse>>(
                System.currentTimeMillis(),
                reportTagihanGajiService.getReportTagihanGaji(nip, unitId, page, size)
        );
